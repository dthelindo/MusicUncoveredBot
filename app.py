...
def main():
    ...
    song_tweet(genre_list["Daily"], song_list)
    song_tweet(genre_list["Pop"], song_list)
    song_tweet(genre_list["Hip Hop"], song_list)
    song_tweet(genre_list["EDM"], song_list)
    song_tweet(genre_list["Country"], song_list)
